# Generated by Django 3.2 on 2023-12-19 16:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.TextField(choices=[('user', 'пользователь'), ('moderator', 'модератор'), ('admin', 'админ')], default='user', help_text='Роль пользователя. Допустимыезначения: user, admin, moderator', verbose_name='Роль')),
