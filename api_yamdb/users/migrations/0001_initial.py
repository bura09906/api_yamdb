    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(help_text='Поле email обязательно для регистрации', max_length=254, unique=True, verbose_name='email address')),
                ('bio', models.TextField(blank=True, help_text='Биография пользователя', verbose_name='Биография')),
                ('role', models.TextField(choices=[('user', 'пользователь'), ('moderator', 'модератор'), ('admin', 'админ')], default='user', help_text='Роль пользователя. Допустимые значения: user, admin, moderator', verbose_name='Роль')),
